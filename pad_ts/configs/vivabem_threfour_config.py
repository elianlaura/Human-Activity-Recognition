...
class Training_args(argparse.Namespace):
    ...
    log_interval = 100
    save_interval = 5e3 # 5e4
    mmd_alpha = 0.0005
    save_dir = f"./OUTPUT/vivabem_three_{ts}/"
...
class Data_args(argparse.Namespace):
    name = "vivabem_three"
    proportion = 1.0
    data_root = "./dataset/vivabem_train_34_N_9_values.csv"  # "./dataset/drinkeat_5040_94u_train.csv", drinkeat_94u_train.csv
    window = 24
    save2npy = True
    neg_one_to_one = True
    seed = 123
