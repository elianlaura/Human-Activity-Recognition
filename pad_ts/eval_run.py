...
def discriminative_score(dataname, iterations, fake_data, length=24):
    ...
    elif dataname == "drinkeat":
        ori_data = np.load(f"./OUTPUT/samples/drinkeat_norm_truth_{length}_train.npy")
    elif dataname == "drinkeats":
        ori_data = np.load(f"./OUTPUT/samples/drinkeats_norm_truth_{length}_train.npy")
    elif dataname == "drinkeats2":
        ori_data = np.load(f"./OUTPUT/samples/drinkeats2_norm_truth_{length}_train.npy")
    elif dataname == "drinkeat_mid":
        ori_data = np.load(f"./OUTPUT/samples/drinkeat_mid_norm_truth_{length}_train.npy")
    elif dataname == "drink":
        ori_data = np.load(f"./OUTPUT/samples/drink_norm_truth_{length}_train.npy")
    elif dataname == "eat":
        ori_data = np.load(f"./OUTPUT/samples/eat_norm_truth_{length}_train.npy")
    else:
